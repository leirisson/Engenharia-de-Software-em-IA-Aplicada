...
const promptFiles = {
    answerPrompt: path.join(promptFolder, "answerPrompt.json"),
    template: path.join(promptFolder, "template.txt")
}
...
export const CONFIG = Object.freeze({
    promptConfig: JSON.parse(readFileSync(promptFiles.answerPrompt, 'utf8')),
    templateText: readFileSync(promptFiles.template, 'utf8'),
    output: {
